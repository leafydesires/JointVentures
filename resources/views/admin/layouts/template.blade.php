...
<head>
    ...
    <title>Joint Ventures Admin</title>
    <!-- General CSS Files -->
...
<body>
                ...
                <ul class="navbar-nav navbar-right">
                            ...
                            <div class="dropdown-list-content dropdown-list-message">
                                <a href="#" class="dropdown-item"> <span
                                        class="dropdown-item-avatar
                                            ...
                                            src="{{ asset('dashboard_assets/assets/img/users/user-1.png') }}"
                                        ...
                                        <img alt="image"
                                            src="{{ asset('dashboard_assets/assets/img/users/user-2.png') }}"
                                            class="rounded-circle">
                                        ...
                                        class="dropdown-item-avatar text-white">
                                        <img alt="image"
                                            src="{{ asset('dashboard_assets/assets/img/users/user-5.png') }}"
                                            class="rounded-circle">
                                        ...
                                        class="dropdown-item-avatar text-white">
                                        <img alt="image"
                                            src="{{ asset('dashboard_assets/assets/img/users/user-4.png') }}img/users/user-4.png"
                                            class="rounded-circle">
                                        ...
                                        class="dropdown-item-avatar text-white">
                                        <img alt="image"
                                            src="{{ asset('dashboard_assets/assets') }}img/users/user-3.png"
                                            class="rounded-circle">
                                        ...
                                        class="dropdown-item-avatar text-white">
                                        <img alt="image"
                                            src="{{ asset('dashboard_assets/assets/img/users/user-3.png') }}img/users/user-2.png"
                                            class="rounded-circle">
                                    </span> <span class="dropdown-item-desc"> <span class="message-user">Sarah
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image"
                                src="{{ asset('dashboard_assets/assets/img/user.png') }}"
                ...
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html"> <img alt="image"
                                src="{{ asset('dashboard_assets/assets/img/logo.png') }}" class="header-logo" />
                            <span class="logo-name">JointVentures</span>
                        </a>
                    </div>
                    <ul class="sidebar-menu">
                        ...
                        <li class="menu-header">Product Maintainance</li>
                        <li class="dropdown">
                            <a href="{{route('admin.addproduct')}}" class="menu-toggle nav-link has-dropdown"><i
                                    data-feather="copy"></i><span>Add Product</span></a>
                            <a href="{{route('admin.allproducts')}}" class="menu-toggle nav-link has-dropdown"><i
                                        data-feather="copy"></i><span>All Products</span></a>
                                        <li class="menu-header">Other Section</li>
                                        <li class="dropdown">
                                            <a href="{{route('admin.messages')}}" class="menu-toggle nav-link has-dropdown"><i
                                                    data-feather="copy"></i><span>Messages</span></a>
    ...
    <!-- JS Libraies -->
    <script src="{{ asset('dashboard_assets/assets/bundles/apexcharts/apexcharts.min.js') }}"></script>
    <!-- Page Specific JS File -->
    <script src="{{ asset('dashboard_assets/assets/js/page/index.js') }}"></script>
    <!-- Template JS File -->
